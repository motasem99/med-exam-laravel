    ...
    <div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    <h2 class="title">edit doctor info</h2>
                    @if($errors->any())
                    ...
                    <form action="{{route('doctor.update',$data->id)}}" method="POST">
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="doctor name" name="doctor_name" value="{{$data->doctor_name}}">
                        </div>
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="age" name="age" value="{{$data->age}}">
                        </div>
                        ...
                        <div class="row row-space">
                            ...
                            <div class="input-group">
                                    <div class="rs-select4 js-select-simple select--no-search">
                                        ...
                                        <option disabled="disabled" selected="selected">patient name</option>
                                            ...
                                            <option value="{{$prow->id}}"@if($data->patient_id==$prow->id) selected @endif>{{$prow->patient_name}}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div style="padding: 5px;">clinic</div>
                                        <select name="clinic_id">
                                            ...
                                            <option value="{{$crow->id}}"@if($data->clinic_id==$crow->id) selected @endif>{{$crow->clinic_name}}</option>
                                            @endforeach
                                        </select>
                                        <div class="select-dropdown"></div>
                                    </div>
